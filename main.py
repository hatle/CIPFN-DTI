...
#  创建参数解析器对象
parser = argparse.ArgumentParser(description="CIPMFDTI for DTI prediction")
parser.add_argument('--cfg', required=True, help="path to config file", type=str)
parser.add_argument('--data', required=True, type=str, metavar='TASK',help='dataset')

parser.add_argument('--split', default='random', type=str, metavar='S', help="split task", choices=['random', 'cold', 'cluster','missing_data/95','missing_data/90','missing_data/80','missing_data/70','unseen_drug'])
